...
rec {
  ...
  workspaceMembers = {
    ...
    "kagerou-orchestrator" = rec {
      packageId = "kagerou-orchestrator";
      build = internal.buildRustCrateWithFeatures {
        packageId = "kagerou-orchestrator";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kagerou-cli" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kagerou-cli; };
        dependencies = [
          {
            name = "clap";
            packageId = "clap";
      ...
      "kagerou-core" = rec {
        crateName = "kagerou-core";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kagerou-core; };
        libName = "kagerou_core";
        dependencies = [
          {
            name = "async-trait";
      ...
      "kagerou-orchestrator" = rec {
        crateName = "kagerou-orchestrator";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./kagerou-orchestrator; };
        libName = "kagerou_orchestrator";
        dependencies = [
          {
            name = "async-trait";
            packageId = "async-trait";
        ...
        features = {
          "kakuremino" = [ "dep:kakuremino" ];
        };
        resolvedDefaultFeatures = [ "kakuremino" ];
      };
      "kakuremino" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "1dbbb2b6e12ca795fa0a8bb3e8b53af4071f5c92";
          sha256 = "0gwik6mbi98zqpp47b4r4slvwsmpzp0v6nwc5rpxfp0wc76aiihw";
        };
        dependencies = [
          {
            name = "async-trait";
