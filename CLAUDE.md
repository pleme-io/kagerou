...
kagerou-cli           — clap CLI (create, destroy, status, wait)
```
...
| File | Purpose |
|------|---------|
| `kagerou-core/src/lib.rs` | Core types, error enum, orchestrator/manager traits |
...
| `kagerou-cli/src/main.rs` | CLI entry point with clap subcommands |
